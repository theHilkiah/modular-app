            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="email" type="email" class="form-control{{ $errors->has('email') ? ' is-invalid' : '' }}"
                                    name="email" value="{{ old('email') }}" required readonly>
                        ...
                        <div class="form-group row">
                            <label for="sec_email" class="col-md-4 col-form-label text-md-right">{{ __('Secondary
                                E-mail') }}</label>

                            <div class="col-md-6">
                                <input id="sec_email" type="email" class="form-control{{ $errors->has('sec_email') ? ' is-invalid' : '' }}"
                                    name="sec_email" value="{{ old('sec_email') }}" required>
